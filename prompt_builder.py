...
class PromptBuilder:
    ...
    def build_translation_prompt(self, style_guide: dict, core_narrative_voice: str, glossary_terms: str, style_analysis: str, source_segment: str, prev_segment_en: str) -> str:
        """
        ...
        context_data = {
            ...
            "glossary_terms": glossary_terms or "No key terms for this segment.",
